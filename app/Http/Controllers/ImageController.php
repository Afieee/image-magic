...
class ImageController extends Controller
{
    ...
    public function process(Request $request)
    {
        $request->validate([
            ...
            'caption' => 'nullable|string|max:255', // Validasi caption
        ]);
        ...
        $watermarkedImageName = $originalImageName . '_watermarked_' . uniqid() . '.' . $imageExtension;
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('image.index')->with('success', 'Post successfully published!');
        } catch (\Exception $e) {
            return back()->withErrors(['error' => $e->getMessage()]);
        }
    }
